...
<html lang="en">
  ...
  <body style="overflow: hidden;">
    <div class="content" style="height: 93vh">
      <h3>
        Welcome to <span style="font-weight: 700">Tech Wallah</span> Institute
      </h3>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 contents">
            <div class="row justify-content-center">
              <div class="col-md-8">
                <div class="mb-4">
                  <h3>Log In to <strong>Associate Admin</strong></h3>
                </div>
                <form action="login" method="post">
                  ...
                  <input
                    ...
                    style="background-color: skyblue; border-color: skyblue"
                  />
                </form>
              </div>
            </div>
